This list [accepts and encourages pull requests](https://github.com/letmerecall/awesome-dapr).

# Contribution Guidelines

- **To add to the list:** Submit a pull request to [README.md](https://github.com/letmerecall/awesome-dapr/blob/main/README.md), optionally add comment if you wish to elaborate/explain. One pull request for one item.
- **To edit an item:** Submit a pull request to [README.md](https://github.com/letmerecall/awesome-dapr/blob/main/README.md), add comment explaining the reasoning behind the change. One pull request for change to one item.
...
This is an attempt to make a curated list of high-quality, maintained, useful Dapr/related software.
